...
<section class="mainright">
	...
	<!-- 	//PHP Code here -->
		...
		<tr>
			...
			<td>
				<?php 
                     echo "<a href='index.php?action=update&id=".$value['id']."'>Update</a>";  
				 ?>

				 ||
		         <?php
				    echo "<a href='index.php?action=delete&id=".$value['id']."' onClick='return confirm(\"Are You Sure to Delete Data\")'>Delete</a>"; 
				    ?>
			</td>
		</tr>
		<?php } ?>	
